...
if __name__ == "__main__":
    ...
    # Reshape raw features to fit LSTM input shape
    time_steps = int(data.shape[-1]/1000)
    num_feat = int(data.shape[-1]/time_steps)
    data = np.reshape(data,(data.shape[0],time_steps,num_feat))
    ...
    training_iterations = 10     # Number of times to repeat training
    ...
    results_filename = 'lstm_raw_best-'+signal_type+'-results.txt'
